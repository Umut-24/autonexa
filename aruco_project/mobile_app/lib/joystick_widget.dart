...
class _JoystickPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Center dot
    canvas.drawCircle(center, 4, Paint()..color = accentColor.withValues(alpha: 0.4));
    ...
    canvas.drawCircle(
      ...
      Paint()
        ..shader = RadialGradient(
          colors: [
            isDragging ? knobColor : knobColor.withValues(alpha: 0.85),
            isDragging ? knobColor.withValues(alpha: 0.8) : knobColor.withValues(alpha: 0.65),
          ],
    ...
    canvas.drawCircle(
      ...
      knobRadius * 0.7,
      Paint()
        ..color = Colors.white.withValues(alpha: isDragging ? 0.25 : 0.15)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 1.5,
    );
    ...
    canvas.drawCircle(
      ...
      knobRadius,
      Paint()
        ..color = knobColor.withValues(alpha: isDragging ? 1.0 : 0.6)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 2,
    );
  }
