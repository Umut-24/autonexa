...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('max_vx_mps',          default_value='0.30',
        ...
        DeclareLaunchArgument('max_ax_mps2',         default_value='0.8'),
        DeclareLaunchArgument('max_aw_radps2',       default_value='1.2'),
        DeclareLaunchArgument('min_vx_creep',        default_value='0.05',
                              description='|vx| below this -> SPEED 0 (chassis coasts under firmware deadband).'),
        ...
        DeclareLaunchArgument('servo_us_min',        default_value='1100',
                              description='Hard min pulse width (us); never sent below this.'),
        DeclareLaunchArgument('servo_us_max',        default_value='1900',
                              description='Hard max pulse width (us); never sent above this.'),
        DeclareLaunchArgument('servo_polarity',      default_value='-1',
                              description='-1 default for this chassis (linkage geometry inverts the standard ROS wz->servo-us mapping). Set to +1 if hardware is rewired symmetrically.'),
